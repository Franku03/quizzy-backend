...
export class CreateKahootTestAPI {
     ...
     */
    public givenTheStorageIsDown(message: string = 'Database Connection Timeout'): this {
        const error = new ErrorData('INFRASTRUCTURE_ERROR', message, ErrorLayer.INFRASTRUCTURE);
    ...
    public async whenCreatingKahoot(): Promise<this> {
        if (!this.currentCommand) {
            throw new Error("No se ha configurado un comando. Usa métodos 'given...Request'");
        }
