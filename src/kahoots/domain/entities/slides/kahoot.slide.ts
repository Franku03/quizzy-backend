...
// File: src\kahoots\domain\entities\slides\kahoot.slide.ts
...
export abstract class Slide extends Entity<SlideProps, SlideId> {
  ...
  protected static checkBaseInvariants(
    props: SlideProps,
    className: string,
  ): Either<ErrorData, true> {
  ...
  public removeOptionByIndex(indexToDelete: number): Either<ErrorData, void> {
    ...
    const newOptionsArray = currentOptions.filter(
  ...
  public addOption(newOption: Option): Either<ErrorData, void> {
    return this.properties.slideType
      .canHaveOption()
      .chain(() =>
        newOption.hasImage()
      ...
      .chain(() => {
        ...
        return this.checkStructuralOptionLimits(newOptionsArray).map(() => {
          this.properties.options = new Optional(newOptionsArray);
        });
      });
  }
  ...
  public changeDescription(
    ...
    return this.properties.slideType.canHaveDescription().map(() => {
      this.properties.description = new Optional(newDescription);
    });
  }

  private checkStructuralOptionLimits(
    options: Option[],
  ): Either<ErrorData, void> {
  ...
  public evaluateAnswer(submission: Submission): Result {
    ...
    return this.properties.evalStrategy.evaluateAnswer(
      newSubmission,
      this.getOptionsList(),
    );
  }
  ...
  public getOptionsList(): Option[] {
    return this.properties.options.hasValue()
  ...
  public abstract changeEvaluationStrategy(
  ...
  public get slideType(): SlideType {
    return this.properties.slideType;
  }
  public get timeLimit(): TimeLimitSeconds {
    return this.properties.timeLimit;
  }
  public get question(): Optional<Question> {
    return this.properties.question;
  }
  public get slideImage(): Optional<ImageId> {
    return this.properties.slideImage;
  }
  public get options(): Optional<Option[]> {
  ...
  public get description(): Optional<Description> {
