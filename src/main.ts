...
// Importacion de adaptadores para la carga de los registros de daos y repositorios.
// Esto es necesario para la ejecucion de los decoradores de los daos y repositorios.
