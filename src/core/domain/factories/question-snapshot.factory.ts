...
// File: src\core\domain\factories\question-snapshot.factory.ts
...
export class QuestionSnapshotFactory {
  ...
  public static createQuestionSnapshotFromResult(
    result: Result,
  ): QuestionSnapshot {
    ...
    if (
      ...
      throw new Error(
        "Cannot create player answer. The player's submission data is missing question details (text and time limit).",
      );
    }
